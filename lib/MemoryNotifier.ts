// from https://github.com/nodemailer/wildduck/blob/master/imap-core/test/memory-notifier.js
'use strict';
...
export class MemoryNotifier extends EventEmitter {
    folders: any;
    logger: any;
     ...
     */
    addListener(session: any, handler: any): any {
     ...
     * @param {Function} handler Function to run once there are new entries in the journal
     */
    removeListener(session: any, handler: any): any {
     ...
     */
    addEntries(mailbox: any, entries: any[], callback: any) {
        ...
        entries.forEach((entry: { modseq: number; }) => {
     ...
     * @param {String} mailbox
     */
    fire(username: string | symbol, payload: any): any {
        setImmediate(() => {
     ...
     */
    getUpdates(mailbox: any, modifyIndex: number, callback: (arg0: null, arg1: string) => any): any {
